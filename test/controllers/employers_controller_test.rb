...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post employers_url, params: { employer: { references: @employer.references } }, as: :json
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { references: @employer.references } }, as: :json
    assert_response 200
  end
